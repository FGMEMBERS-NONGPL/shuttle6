...
# ===== for Type 6 Shuttlecraft  version 15.0            =======
...
#			walker0_node.getNode("trigger-upon", 1).setValue(i3);
	...
	showDialog: func {
		...
		box.set("live", 1);
		box.set("min", -197);	# -180 minus pilot sitting offset
		box.set("max", 163);	#  180 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("property", "sim/model/walker[0]/limb[0]/z-m");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/walker[0]/limb[0]/z-m");
		number.set("pref-width", 32);
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -123);	# -135 minus pilot sitting offset
		box.set("max", 57);	#   45 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -80.5);	# -90.5 minus pilot sitting offset
		box.set("max", 72.5);	#  62.5 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -15);	# -85 minus pilot sitting offset
		box.set("max", 165);	#  95 minus pilot sitting offset
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -91);	# -90 minus pilot sitting offset
		box.set("max", 179);	# 180 minus pilot sitting offset
		box.setColor(0.5, 1, 0.5);
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -89);	# -106 minus pilot sitting offset
		box.set("max", 109);	#   92 minus pilot sitting offset
		box.setColor(0.5, 1, 0.5);
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
...
#		g.addChild("empty").set("pref-width", 4);
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -63);	#   0 minus pilot sitting offset
		box.set("max", 87);	# 150 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -92);	# -90 minus pilot sitting offset
		box.set("max", 68);	#  70 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -29);	# -90 minus pilot sitting offset
		box.set("max", 241);	# 180 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("property", "sim/model/walker[0]/limb[6]/x-deg");
		box.set("legend", "Left Arm1 down  < >  up                      ");
		box.set("pref-width", 200);
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -6);	# -85 minus pilot sitting offset
		box.set("max", 174);	#  95 minus pilot sitting offset
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/walker[0]/limb[6]/x-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/walker[0]/limb[6]/y-deg");
		box.set("legend", "     counter-clockwise < > clockwise");
		box.set("pref-width", 240);
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -189);	# -180 minus pilot sitting offset
		box.set("max", 81);	#   90 minus pilot sitting offset
		box.setColor(1, 0.5, 0.5);
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/walker[0]/limb[6]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/walker[0]/limb[6]/z-deg");
		box.set("legend", "Left Arm1 forward right  < >  back left                 ");
		box.set("pref-width", 220);
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -85);	# -106 minus pilot sitting offset
		box.set("max", 113);	#   92 minus pilot sitting offset
		box.setColor(1, 0.5, 0.5);
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/walker[0]/limb[6]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
...
#		box.set("property", "sim/model/walker[0]/limb[7]/y-deg");
#		box.set("legend", "counter-clockwise < > clockwise");
#		box.set("pref-width", 300);
#		box.set("pref-height", 16);
#		box.set("live", 1);
...
#		g.addChild("empty").set("stretch", 1);
#		var number = g.addChild("text");
#		number.set("property", "sim/model/walker[0]/limb[7]/y-deg");
#		number.set("pref-width", 32);
#		number.set("format", "%6.1f");
#		number.set("live", 1);
#		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/walker[0]/limb[7]/z-deg");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/walker[0]/limb[7]/z-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("property", "sim/model/walker[0]/limb[8]/x-deg");
		box.set("legend", "Left Hand down  < >  up               ");
		box.set("pref-width", 176);
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -100);	# -90 minus pilot sitting offset
		box.set("max", 60);	#  70 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/walker[0]/limb[8]/x-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
...
#		g.addChild("empty").set("pref-width", 2);
		...
		box.set("property", "sim/model/walker[0]/limb[8]/y-deg");
		box.set("legend", "    counter-clockwise < > clockwise");
		box.set("pref-width", 233);
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -249);	# -180 minus pilot sitting offset
		box.set("max", 21);	#   90 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		g.addChild("empty").set("stretch", 1);
		var number = g.addChild("text");
		number.set("property", "sim/model/walker[0]/limb[8]/y-deg");
		number.set("pref-width", 32);
		number.set("format", "%6.1f");
		number.set("live", 1);
		g.addChild("empty").set("pref-width", 4);
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -65.0);	# -135 minus pilot sitting offset
		box.set("max", 151.0);	#   81 minus pilot sitting offset
		box.setColor(0.5, 1, 0.5);
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -70);	# -14 minus pilot sitting offset
		box.set("max", 74);	# 130 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
		...
		box.set("pref-height", 16);
		box.set("live", 1);
		box.set("min", -14);	# -45 minus pilot sitting offset
		box.set("max", 76);	#  45 minus pilot sitting offset
		box.prop().getNode("binding[0]/command", 1).setValue("dialog-apply");
